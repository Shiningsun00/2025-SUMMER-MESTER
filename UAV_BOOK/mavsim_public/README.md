...
- Source: [https://github.com/byu-magicc/mavsim_public](https://github.com/byu-magicc/mavsim_public)
- License: GNU General Public License v3.0 (GPLv3)

Modifications have been made to the original MAVSim codebase for research and academic purposes, including:
- Custom flight scenarios
- Extended logging and plotting tools
- Architecture refactoring and parameter tuning

All modifications comply with GPLv3 requirements:
- The modified source code is fully disclosed
- This project remains under GPLv3
- Changes are clearly indicated and documented

© [2025] Portions of the code are © BYU MAGICC Lab. This modified version is used and redistributed for academic use only.
